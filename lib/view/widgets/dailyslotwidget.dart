...
class DailySlotWidget extends StatelessWidget {
  ...
  final DailySlotController dailyslotController = Get.find<DailySlotController>();
  ...
  Widget build(BuildContext context) {
    dailyslotController.timelist.add(slot.time);
    return Container(
                              ...
                              child: GridTile(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Center(
                                      child: Text(
                                        "Do you want to Remove the Slot",
                                      ...
                                      onPressed: () async {
                                        ...
                                        var response =
                                            await networkHandler.post2(
                                                "/canceldailyAppointment",
                                                data);
                                        if (response.statusCode == 200 ||
                                            response.statusCode == 201) {
                                          dailyslotController.dailybookedList
                                              .remove(slot);
                                          Get.back();
                                          Get.back();
                                        } else {
